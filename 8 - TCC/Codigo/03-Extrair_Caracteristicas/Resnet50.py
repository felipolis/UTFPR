...
arquivo_csv = '../data/caracteristicas/RESNET50_[PATCHES-100-COLUNAS]_[02-CLASSES].csv' # MUDAR AQUI
...
def main():
      ...
      if key in classes:
          ...
          for image_name in os.listdir(key_path):
              ...
              if latitude is not None and longitude is not None:
                ...
                caracteristicas_Resnet50 = extrair_caracteristicas_ResNet50(imagem)

                # Adicione as características ao DataFrame
                data_to_append = pd.Series([key, nome_arquivo_original, latitude, longitude] + list(caracteristicas_Resnet50))
  ...
  colunas = ['key', 'nome_arquivo', 'latitude', 'longitude'] + [f'RESNET50_{i}' for i in range(len(caracteristicas_Resnet50))]
  df.columns = colunas

...
arquivo_csv = '../data/caracteristicas/LBP_[PATCHES-500-COLUNAS]_[10-CLASSES].csv' # MUDAR AQUI
diretorio_caracteristicas = '../data/caracteristicas/'
arquivo_metadata = '../data/metadata.csv'

# Parâmetros LBP
QUANT_CLASSES = 10 # MUDAR AQUI
POINTS = 8
RADIUS = 2
...
def main():
        ...
        if key in classes:
            ...
            for image_name in os.listdir(key_path):
                ...
                if latitude is not None and longitude is not None:
                    ...
                    data_to_append = pd.Series([key, nome_arquivo_original, latitude, longitude] + list(caracteristicas_lbp))
    ...
    colunas = ['key', 'nome_arquivo', 'latitude', 'longitude'] + [f'LBP_{i}' for i in range(len(caracteristicas_lbp))]
    df.columns = colunas

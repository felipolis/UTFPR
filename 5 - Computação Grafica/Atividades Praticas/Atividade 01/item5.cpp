// Pegar a hora o minuto e o segundo atual
...
int init(void){
    ...
    cout << "Hora: " << ltm->tm_hour << endl;
    cout << "Minuto: " << ltm->tm_min << endl;
    cout << "Segundo: " << ltm->tm_sec << endl;
...
void horaToAngle(){
    angle_seg = 360 - (segundo * 6) + 90;
    angle_min = 360 - (minuto * 6) + 90;
    angle_hor = 360 - (hora * 30) + 90;
}